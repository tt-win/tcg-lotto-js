...
const groupLFConfig = {
  ...
  // All5Straight_LF_Single 五星直选(单式)
  2880: ballBoardConfigLF[2879],
  // P5First4Straight_LF_Single P5前四直选(单式)
  2884: ballBoardConfigLF[2883],
  // P5Last4Straight_LF_Single P5后四直选(单式)
  2888: ballBoardConfigLF[2887],
