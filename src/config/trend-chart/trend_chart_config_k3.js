...
const K3 = {
  ...
  list: {
    ...
    Sum: {
      column: ['numero', 'drawNumber', 'numberSpread', 'sumDigit', 'pair_K3', 'com6_K3', 'baozi_K3', 'sumBSOE'],
      h5Column: ['numero', 'drawNumber', 'numberSpread', 'sumDigit', 'pair_K3', 'com6_K3', 'baozi_K3', 'sumBSOE'],
      options: {
        ballDigit: [0, 2],
        sumDigit: ['sumDigit'],
      },
