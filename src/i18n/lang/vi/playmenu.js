const PlayMenu = {
  playId: {
    ...
    2517: 'Lô 2 Số - Nhanh', // 后二包胆
    2518: 'Lô 2 Số - Chọn Số', // 后二包胆(复式)
    2519: 'Lô 2 Số - Nhập Số', // 后二包胆(单式)
    2521: 'Lô 3 Số - Nhanh', // 后三包胆
    2522: 'Lô 3 Số - Chọn Số', // 后三包胆（复式）
    2523: 'Lô 3 Số - Nhập Số', // 后三包胆（单式）
    2525: 'Lô 4 Số - Nhanh', // 后四包胆
    2526: 'Lô 4 Số - Chọn Số', // 后四包胆（复式）
    2527: 'Lô 4 Số - Nhập Số', // 后四包胆（单式）
    ...
    2530: 'Lô 2 Số - Nhanh', // 后二包胆
    2531: 'Lô 2 Số - Chọn Số', // 后二包胆(复式)
    2532: 'Lô 2 Số - Nhập Số', // 后二包胆(单式)
    2534: 'Lô 3 Số - Nhanh', // 后三包胆
    2535: 'Lô 3 Số - Chọn Số', // 后三包胆（复式）
    2536: 'Lô 3 Số - Nhập Số', // 后三包胆（单式）
    2538: 'Lô 4 Số - Nhanh', // 后四包胆
    2539: 'Lô 4 Số - Chọn Số', // 后四包胆（复式）
    2540: 'Lô 4 Số - Nhập Số', // 后四包胆（单式）

    2562: 'Trượt Xiên 4 - Nhanh',  // 南部 - 四不中 - 三級選單
    2563: 'Trượt Xiên 4 - Nhập Số', // 南部 - 四不中(单式) - 三級選單
    2565: 'Trượt Xiên 8 - Nhanh', // 南部 - 八不中 - 三級選單
