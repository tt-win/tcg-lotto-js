...
const LANG = {
  ...
  errorCode: {
    ...
    LGS_BETTING_AMOUNT_LESS_THAN_MINIMUM_ERROR: '该玩法单注金额不能低于：',
    // TL swertejtf2
    ...
    CUSTOMER_NOT_ALLOW_PLAY_LOTTERY: '将您的奖金投注于特定游戏。您尚未达到所申领奖金的投注要求。',
  },
  chasingStatus: {
    All: '全部',
    Chasing: '仅追号单',
  ...
  skipOneClickBetTodayMsg: '今日不再显示',
...
请导入TXT文件丶复制或者输入支持格式如下：`,
  ...
  manualBetAmountIntegerPlaceHolderSEA: '单注格式为：号码@金额（金额请输入整数）',
