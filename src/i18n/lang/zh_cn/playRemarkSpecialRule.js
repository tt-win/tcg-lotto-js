...
export default {
  ...
  QQFFC: '数据将全部取自腾讯QQ官网，规则具体介绍如下：<br />\n' +
         ...
         '5、QQ/腾讯分分彩种每分钟一期，全天24小时不间断开放。<br />\n' +
         '6、腾讯QQ官网：http://im.qq.com/ (首页右上方为在线统计人数），奇趣统计官网：http://www.77tj.org/。<br />',
  HK6: '每周一、周二、周六（或周日）开奖；周六如遇赛马延至周日开奖',
  BJLK28: '幸运28开奖结果来源于国家福利彩票北京快乐8(官网)开奖号码，每期开奖共开出20个数字，幸运28将这20个开奖号码按照由小到大的顺序依次排列；<br />\n' +
  ...
  TW28: '台湾PC蛋蛋开奖结果来源于台湾乐透彩券(官网)开奖号码，每期开奖共开出20个数字，幸运28将这20个开奖号码按照由小到大的顺序依次排列；<br />\n' +
  ...
  CA28: '来源于加拿大Bingo（官网）开奖号码；每年根据夏、冬令时调整休市时间，每期开奖共开出20个数字，幸运28将这20个开奖号码按照由小到大的顺序依次排列；<br />\n' +
        ...
        '取其13-18位开奖号码相加，和值的末位数作为开奖第三个数值；<br />\n' +
        '三个数值相加即为最终的开奖结果。<br />',
  BJ28: '北京28结果也是来源于国家福利彩票北京快乐8结果号码，和幸运28取得位数不同，从早上9:05至23:55，每5分钟一期不停。<br />\n' +
  ...
  CAPK28: '加拿大PK28结果也是来源于加拿大Bingoe官方网站结果号码。<br />\n' +
  ...
  TWPK28: '台湾PK28结果也是来源于台湾乐透彩券网站结果号码。<br />\n' +
          '每期结果共开出20个数字，将这20个结果号码按照由小到大的顺序依次排列；<br />\n' +
          '取其2/5/8/11/14/17位开出号码相加，和值的末位数作为开出第一个数值；<br />\n' +
          '取其3/6/9/12/15/18位开出号码相加，和值的末位数作为开出第二个数值，<br />\n' +
          '取其4/7/10/13/16/19位开出号码相加，和值的末位数作为开出第三个数值；<br />\n' +
