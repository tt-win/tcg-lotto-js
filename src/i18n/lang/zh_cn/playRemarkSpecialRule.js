...
`,
  ZDFSEFFC: `
  首尔分分彩是依照世界各国家基诺彩票官方开奖结果所精心设计的游戏，由基诺彩随机开出的20个奖号，再组合成为分分彩的5个开奖号码，每1分钟进行一期游戏，全天24个小时不间断。 <br />\n 
  由5个开奖号码，变化成各式不同的玩法，根据投注的号码个数与玩法，可获得不同等级的彩金。此游戏的开奖时间和相对应地区官方基诺彩完全同步。<br />\n 
  分分彩拥有高达15种玩法，让您一夜致富不再是梦想。组选的幸运号码组合，则给您与众不同的投注灵感。祝您鸿运当头！<br />\n 
`,
};
