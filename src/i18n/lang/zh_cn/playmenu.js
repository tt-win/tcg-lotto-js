...
const PlayMenu = {
  playId: {
    ...
    2685: '上正二位数', // SEA TL3D 後二直選(上正 二數)
    2687: '下正二位数', // SEA TL3D 後二組選(下正 二數)
    2690: '上正三位数', // SEA TL3D 後三直選(上正 三數)
    2692: '上反三位数', // SEA TL3D 後三組選(上反 三數)
    2695: '一等二星不定位', // SEA TL3D 后二不定位

    // TL4D

    2698: '上正二位数', // SEA TL4D 後二直選(上正 二數)
    2700: '下正二位数', // SEA TL4D 後二組選(下正 二數)
    2703: '上正三位数', // SEA TL4D 後三直選(上正 三數)
    2705: '上反三位数', // SEA TL4D 後三組選(上反 三數)
    2708: '上正四位数', // SEA TL4D 後四直選(上正 四數)
    2710: '上反四位数', // SEA TL4D 後四組選(上反 四數)
    2713: '一等二星不定位', // SEA TL4D 后二不定位

    // TL6D

    2716: '上正二位数', // SEA TL6D 後二直選(上正 二數)
    2718: '下正二位数', // SEA TL6D 後二組選(下正 二數)
