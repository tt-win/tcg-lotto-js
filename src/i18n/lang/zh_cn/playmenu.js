...
const PlayMenu = {
  playId: {
    ...
    2716: '上正二位数', // SEA TL6D 後二直選(上正 二數)
    2718: '上反二位数', // SEA TL6D 後二組選(上反 二數)
    2721: '上正三位数', // SEA TL6D 後三直選(上正 三數)
    2723: '上反三位数', // SEA TL6D 後三組選(上反 三數)
    2726: '上正四位数', // SEA TL6D 後四直選(上正 四數)
    2728: '上反四位数', // SEA TL6D 後四組選(上反 四數)
    ...
    2686: '上正二位数', // SEA TL3D 上正二位数
    2688: '上反二位数', // SEA TL3D 上反二位数
    2691: '上正三位数', // SEA TL3D 上正三位数
    2693: '上反三位数', // SEA TL3D 上反三位数
    2696: '上跑两位数', // SEA TL3D 上跑两位数

    // TL4D

    2699: '上正二位数', // SEA TL4D 上正二位数
    2701: '上反二位数', // SEA TL4D 上反二位数
    2704: '上正三位数', // SEA TL4D 上正三位数
    2706: '上反三位数', // SEA TL4D 上反三位数
    2709: '上正四位数', // SEA TL4D 上正四位数
    2711: '上反四位数', // SEA TL4D 上反四位数
    2714: '上跑两位数', // SEA TL4D 上跑两位数

    // TL6D

    2717: '上正二位数', // SEA TL6D 上正二位数
    2719: '上反二位数', // SEA TL6D 上反二位数
    2722: '上正三位数', // SEA TL6D 上正三位数
    2724: '上反三位数', // SEA TL6D 上反三位数
    2727: '上正四位数', // SEA TL6D 上正四位数
    2729: '上反四位数', // SEA TL6D 上反四位数
    2732: '上跑两位数', // SEA TL6D 上跑两位数
