...
const PlayMenu = {
  playId: {
    ...
    2516: '后二包胆', // 后二包胆
    2517: '后二包胆', // 后二包胆
    2518: '后二包胆（复式）', // 后二包胆（复式）
    2519: '后二包胆（单式）', // 后二包胆（单式）
    2520: '后三包胆', // 后三包胆
    2521: '后三包胆', // 后三包胆
    2522: '后三包胆（复式）', // 后三包胆（复式）
    2523: '后三包胆（单式）', // 后三包胆（单式）
    2524: '后四包胆', // 后四包胆
    2525: '后四包胆', // 后四包胆
    2526: '后四包胆(复式)', // 后四包胆（复式）
    2527: '后四包胆(单式)', // 后四包胆（单式
    2550: '逆向', // 北部 逆向 - 一級選單
    ...
    2529: '后二包胆', // 后二包胆
    2530: '后二包胆', // 后二包胆
    2531: '后二包胆（复式）', // 后二包胆（复式）
    2532: '后二包胆（单式）', // 后二包胆（单式）
    2533: '后三包胆', // 后三包胆
    2534: '后三包胆', // 后三包胆
    2535: '后三包胆（复式）', // 后三包胆（复式）
    2536: '后三包胆（单式）', // 后三包胆（单式）
    2537: '后四包胆', // 后四包胆
    2538: '后四包胆', // 后四包胆
    2539: '后四包胆(复式)', // 后四包胆（复式）
    2540: '后四包胆(单式)', // 后四包胆（单式
    2560: '逆向', // 南部 逆向 - 一級選單
    2561: '四位逆向',  // 南部 - 四不中 - 二級選單
    2564: '八位逆向',  // 南部 - 八不中 - 二級選單
    2567: '十位逆向',  // 南部 - 十不中 - 二級選單
    2562: '四不中', // 南部 - 四不中 - 三級選單
    2563: '四不中(单式)', // 南部 - 四不中(单式) - 三級選單
    2565: '八不中', // 南部 - 八不中 - 三級選單
    2566: '八不中(单式)', // 南部 - 八不中(单式) - 三級選單
    2568: '十不中', // 南部 - 十不中 - 三級選單
    2569: '十不中(单式)', // 南部 - 十不中(单式) - 三級選單
