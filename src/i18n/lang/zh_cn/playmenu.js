...
const PlayMenu = {
  playId: {
    ...
    2552: '四不中',  // 北部 - 四不中 - 三級選單
    2553: '四不中(单式)', // 北部 - 四不中(单式) - 三級選單
    2555: '八不中', // 北部 - 八不中 - 三級選單
    2556: '八不中(单式)', // 北部 - 八不中(单式) - 三級選單
    2558: '十不中', // 北部 - 十不中 - 三級選單
    2559: '十不中(单式)', // 北部 - 十不中(单式) - 三級選單

    2585: '二数头尾', // 北部 二数头尾 Last_2_1st_7th_North_VNC
    2586: '二数头尾 (单式)', // 北部 二数头尾 (单式) Last_2_1st_7th_North_VNC_Single
    2587: '二数头尾（复式)', // 北部 二数头尾（复式) Last_2_1st_7th_North_VNC_Multi
    2588: '二数头', // 北部 二数头 Last_2_7th_North_VNC
    ...
    2562: '四不中', // 中南部 - 四不中 - 三級選單
    2563: '四不中(单式)', // 中南部 - 四不中(单式) - 三級選單
    2565: '八不中', // 中南部 - 八不中 - 三級選單
    2566: '八不中(单式)', // 中南部 - 八不中(单式) - 三級選單
    2568: '十不中', // 中南部 - 十不中 - 三級選單
