const PlayMenu = {
  playId: {
    ...
    2515: 'Gulungan Apapun', // 包膽 北部
    2528: 'Gulungan Apapun', // 包膽 中南部

    2550: 'Gagal parlay', // 北部 逆向 - 一級選單
    2560: 'Gagal parlay', // 中南部 逆向 - 一級選單

    2598: 'Parlay', // 北部 串组 - 一級選單
    2608: 'Parlay', // 中南部 串组 - 一級選單

    2300: 'Ikan udang kepiting', // 魚蝦蟹
    2488: 'FanTan', // 番摊

    2618: 'Super Sicbo', // 骰寶快三

    2624: '1 - 10 Peringkat', // 极速PK10 - 第1-10名排名
    2627: 'Jumlah pertama & kedua', // 极速PK10 - 冠亚和值
    2630: 'Naga & harimau', // 极速PK10 - 龙虎斗
    ...
    2628: 'Jumlah pertama & kedua', // 极速PK10 - 冠亚和值-二級選單
    2629: 'Jumlah BSOE 1 & 2', // 极速PK10 - 冠亚和值-大小单双
    2631: 'Naga & harimau', // 极速PK10 - 龙虎斗-二級選單

    2516: '2D terakhir dari hasil apa pun', // 北部 后二包胆
    ...
    2584: 'Kepala 2D &spesial', // 北部 - 二数头尾 - 二級選單
    ...
    2567: 'Gagal parlay 10', // 中南部 - 十不中 - 二級選單

    2609: 'Parlay 2', // 中南部 - 串2组 - 二級選單
    2612: 'Parlay 3', // 中南部 - 串3组 - 二級選單
    2615: 'Parlay 4', // 中南部 - 串4组 - 二級選單

    2591: 'Kepala 2D &spesial', // 中南部 - 二数头尾 - 二級選單

    2106: 'Acak', // 跑數二級選單
    2108: 'Acak', // 跑數二級選單

    2579: 'Acak', // 特等一等 - 十位個位 - 跑數 - 二級選單
    ...
    2552: 'Gagal parlay 4', // 北部 - 四不中
    2555: 'Gagal parlay 8', // 北部 - 八不中
    2558: 'Gagalparlay 10', // 北部 - 十不中
    2562: 'Gagal parlay 4', // 中南部 - 四不中
    2565: 'Gagal parlay 8', // 中南部 - 八不中
    2568: 'Gagalparlay 10', // 中南部 - 十不中

    2517: '2D terakhir dari hasil apa pun', // 北部 后二包胆
    2521: '3D terakhir dari hasil apa pun', // 北部 后三包胆
    2525: '4D terakhir dari hasil apa pun', // 北部 后四包胆
    2530: '2D terakhir dari hasil apa pun', // 中南部 后二包胆
    2534: '3D terakhir dari hasil apa pun', // 中南部 后三包胆
    2538: '4D terakhir dari hasil apa pun', // 中南部 后四包胆

    2641: '2D 1k terakhir dari hasil apa pun', // 北部 后二包胆 1K
    2642: '2D 1k terakhir dari hasil apa pun', // 中南部 后二包胆 1K

    2586: 'Kepala 2D &spesial', // 北部 二数头尾 Last_2_1st_7th_North_VNC
    2589: 'Kepala 2D', // 北部 二数头 Last_2_7th_North_VNC
    2593: 'Kepala 2D &spesial', // 中南部 二数头尾 Last_2_1st_8th_South_VNC
    2596: 'Kepala 2D', // 中南部 二数头 Last_2_8th_South_VNC

    2580: 'Puluhan - spesial', // 特等十位 Ten_Digit_1st_VNC
    2581: 'Satu -spesial', // 特等个位 Unit_Digit_1st_VNC
    2582: 'Puluhan -1st', // 一等十位 Ten_Digit_2nd_VNC
    2583: 'Satu -1st', // 一等个位 Unit_Digit_2nd_VNC
