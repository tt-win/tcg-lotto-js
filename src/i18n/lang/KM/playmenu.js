const PlayMenu = {
  playId: {
    ...
    2685: 'ជាក់ស្តែង', // SEA TL3D 後二直選(上正 二數)
    2687: 'ក្រុម', // SEA TL3D 後二組選(上反 二數)
    2690: 'ជាក់ស្តែង', // SEA TL3D 後三直選(上正 三數)
    2692: 'ក្រុម', // SEA TL3D 後三組選(上反 三數)
    2695: 'Random', // SEA TL3D 后二不定位

    // TL4D

    2698: 'ជាក់ស្តែង', // SEA TL4D 後二直選(上正 二數)
    2700: 'ក្រុម', // SEA TL4D 後二組選(上反 二數)
    2703: 'ជាក់ស្តែង', // SEA TL4D 後三直選(上正 三數)
    2705: 'ក្រុម', // SEA TL4D 後三組選(上反 三數)
    2708: 'ជាក់ស្តែង', // SEA TL4D 後四直選(上正 四數)
    2710: 'ក្រុម', // SEA TL4D 後四組選(上反 四數)
    2713: 'Random', // SEA TL4D 后二不定位

    // TL6D

    2716: 'ជាក់ស្តែង', // SEA TL6D 後二直選(上正 二數)
    2718: 'ក្រុម', // SEA TL6D 後二組選(上反 二數)
    2721: 'ជាក់ស្តែង', // SEA TL6D 後三直選(上正 三數)
    2723: 'ក្រុម', // SEA TL6D 後三組選(上反 三數)
    2726: 'ជាក់ស្តែង', // SEA TL6D 後四直選(上正 四數)
    2728: 'ក្រុម', // SEA TL6D 後四組選(上反 四數)
    ...
    2686: 'តួលេខពីរខ្ទង់', // SEA TL3D 上正二位数
    2688: 'លេខពីរខ្ទង់លើ', // SEA TL3D 上反二位数
    2691: 'តួលេខបីខ្ទង់', // SEA TL3D 上正三位数
    2693: 'លេខបីខ្ទង់លើ', // SEA TL3D 上反三位数
    2696: 'រត់ពីរខ្ទង់', // SEA TL3D 上跑两位数

    // TL4D

    2699: 'តួលេខពីរខ្ទង់', // SEA TL4D 上正二位数
    2701: 'លេខពីរខ្ទង់លើ', // SEA TL4D 上反二位数
    2704: 'តួលេខបីខ្ទង់', // SEA TL4D 上正三位数
    2706: 'លេខបីខ្ទង់លើ', // SEA TL4D 上反三位数
    2709: 'តួលេខពបួនខ្ទង់', // SEA TL4D 上正四位数
    2711: 'លេខបួនខ្ទង់លើ', // SEA TL4D 上反四位数
    2714: 'រត់ពីរខ្ទង់', // SEA TL4D 上跑两位数

    // TL6D

    2717: 'តួលេខពីរខ្ទង់', // SEA TL6D 上正二位数
    2719: 'លេខពីរខ្ទង់លើ', // SEA TL6D 上反二位数
    2722: 'តួលេខបីខ្ទង់', // SEA TL6D 上正三位数
    2724: 'លេខបីខ្ទង់លើ', // SEA TL6D 上反三位数
    2727: 'តួលេខពបួនខ្ទង់', // SEA TL6D 上正四位数
    2729: 'លេខបួនខ្ទង់លើ', // SEA TL6D 上反四位数
    2732: 'រត់ពីរខ្ទង់', // SEA TL6D 上跑两位数
