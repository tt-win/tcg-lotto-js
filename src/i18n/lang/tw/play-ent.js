...
const ARR_BSOE = ['大', '小', '單', '雙'];
const ARR_TOTALSUM = ['大', '小', '單', '雙'];
const ARR_SPECIAL = ['豹子', '順子', '對子', '雜六', '半順'];
const ARR_DRAGON = ['虎', '龍', '和'];
...
const ARR_EXTREMUM = ['極大', '極小'];
const ARR_COLOR = ['', '紅', '藍', '綠'];
const ARR_BOE = ['大單', '大雙'];
const ARR_SOE = ['小單', '小雙'];
const ARR_K3_RED_BLACK = ['紅', '黑'];
...
const ARR_TOTAL_SUM_GROUP = ['和大', '和小', '和單', '和雙', '尾大', '尾小'];
