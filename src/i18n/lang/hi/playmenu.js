const PlayMenu = {
  playId: {
    ...
    2063: 'ऊपरी विपरीत', // 上反
    2643: 'दूसरा स्थान', // 二等
    2644: 'दूसरा विशेष स्थान', // 二特
    2065: 'सिधे चयन के अतिरिक्त', // 直选加开
    2068: 'आखिरी तीन निर्दिष्ट नहीं', // 后三不定位

    2298: 'मछली, झींगा, केकड़ा', // 魚蝦蟹
    ...
    2062: 'उपरी सही दो अंकों की संख्या', // 上正二位数
    2064: 'उपरी विपरीत दो अंकों की', // 上反二位数
    2066: 'निचले सही दो अंकों की संख्या ', // 下正二位数
    2480: 'निचले सही दो अंकों की संख्या ',
    2481: 'निचले सही दो अंकों की संख्या ',
    2482: 'उपरी विपरीत दो अंकों की संख्या',
    2483: 'उपरी सही दो अंकों की संख्या',
    2484: 'उपरी सही दो अंकों की संख्या',

    2057: 'उपरी सही तीन अंकों की संख्या', // 上正三位数
    2059: 'उपरी विपरीत तीन अंकों की संख्या', // 上反三位数
    2645: 'दूसरे स्थान की तीन अंकों की संख्या', // 二等三位数
    2646: 'दूसरे विशेष स्थान की तीन अंकों की संख्या', // 二特三位数
    2069: 'उपरी चलती तीन अंकों की संख्या', // 上跑三位数
    2485: 'उपरी सही तीन अंकों की संख्या',
    2486: 'उपरी सही तीन अंकों की संख्या',
    2487: 'उपरी विपरीत तीन अंकों की संख्या',

    2299: 'मछली, झींगा, केकड़ा', // 魚蝦蟹
    ...
    2091: 'ऊपरी सही', // 四数 上正
    2093: 'ऊपरी विपरीत', // 四数 上反
    2096: 'ऊपरी सही', // 三数 上正
    2098: 'ऊपरी विपरीत', // 三数 上反
    2101: 'ऊपरी सही', // 二数 上正
    2103: 'ऊपरी सही', // 二数 下正

    2301: 'मछली, झींगा, केकड़ा', // 魚蝦蟹
    ...
    2106: 'निर्धारित नहीं', // 跑數二級選單
    2108: 'निर्धारित नहीं', // 跑數二級選單

    2579: 'निर्धारित नहीं', // 特等一等 - 十位個位 - 跑數 - 二級選單
    ...
    2102: 'निचले सही दो अंकों की', // 上正二位数 Last_2_Straight_1st_VNC
    2104: 'उपरी सही दो अंकों की संख्या', // 下正二位数 Last_2_Straight_2nd_VNC
    ...
    2279: 'निचले सही दो अंकों की संख्या', // 上正二位数(复式) Last_2_Straight_1st_VNC_Multi
    2280: 'निचले सही दो अंकों की संख्या', // 上正二位数（单式）Last_2_Straight_1st_VNC_Single
    2281: 'उपरी सही दो अंकों की संख्या', // 下正二位数（复式）Last_2_Straight_2nd_VNC_Multi
    2282: 'उपरी सही दो अंकों की संख्या', // 下正二位数（单式）Last_2_Straight_2nd_VNC_Single
    ...
    2143: 'निर्धारित नहीं', // 跑數二級選單
    2145: 'निर्धारित नहीं', // 跑數二級選單

    2304: 'मछली, झींगा, केकड़ा', // 魚蝦蟹
    ...
    2657: 'बड़ा,छोटा,समान', // 趣味 - 總和大小 Total_Sum_BST_KENO
    2658: 'एकल, दोहरा', // 趣味 - 總和單雙 Total_Sum_OE_KENO
    2659: 'परले बड़ा छोटा, एकल, दोहरा', // 趣味 - 總和過關 Total_Sum_PASS_KENO
    2660: 'ऊपर,मध्य,नीचे', // 趣味 - 上下盤 UpDown_KENO
    2661: 'विषम, समान,सम', // 趣味 - 奇偶盤 OddEven_KENO
    ...
    3100: '1-10 रैंकिंग', // SEA SEAPK10 第1-10名排名
    3101: '1-10 बड़ाछोटा', // SEA SEAPK10 第1-10名大小
    3102: '1-10 विषमसम', // SEA SEAPK10 第1-10名單雙

    // SEAPK10-Level:2

    3103: '1-10 रैंकिंग', // SEA SEAPK10 第1-10名排名
    3104: '1-10 बड़ाछोटा', // SEA SEAPK10 第1-10名大小
    3105: '1-10 विषमसम', // SEA SEAPK10 第1-10名單雙

    // SEAPK10-Level:3

    3106: '1-10 रैंकिंग', // SEA SEAPK10 排名
